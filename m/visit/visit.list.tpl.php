...
<div class="headers">
	...
	<div class="headers_oprate"><form name="topform" method="GET"><input type="hidden" name="op" value="<?php echo $op; ?>"><input type="hidden" name="sid" value="<?php echo $sid; ?>">&nbsp;&nbsp;&nbsp;&nbsp;模糊搜索：<input name="searchword" value="<?php echo $_GET["searchword"]; ?>" class="input" size="12">&nbsp;<input type="submit" class="search" value="搜索" style="font-weight:bold" title="点击搜索">&nbsp;<input type="button" value="重置" onclick="location='?op=list&sid=<?php echo $sid; ?>'" class="search" title="退出条件查询"></form></div>
</div>
<!-- 头部 end -->
