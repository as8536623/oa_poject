...
$list = $db->query("select id,date,kefu,addtime,u_realname,log from $table where hid=$hid and sub_id=$sub_id and date>=$begin and date<=$end order by date desc,kefu asc", "id");
...
.li_kefu {display:inline; width:120px; color:#408080; float:left; }
.log_data {float:left; }
</style>
