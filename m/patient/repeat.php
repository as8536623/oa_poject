...
// - 创建时间 : 2009-08-18 10:31
*/
require "../../core/core.php";
$table = "patient_".$hid;

//exit_html("对不起，该功能正在调整，稍后开通...");
...
$aTdFormat = array(
	...
	7=>array("title"=>"预约时间", "width"=>"", "align"=>"center", "sort"=>"order_sort", "defaultorder"=>2),
	...
	12=>array("title"=>"客服", "width"=>"", "align"=>"center", "sort"=>"author", "defaultorder"=>1),
	13=>array("title"=>"赴约情况", "width"=>"", "align"=>"center", "sort"=>"status_1", "defaultorder"=>2, "sort2"=>"addtime desc"),
	1=>array("title"=>"添加时间", "width"=>"", "align"=>"center", "sort"=>"addtime", "defaultorder"=>2),
...
<!-- 头部 begin -->
<div class="headers">
	<div class="headers_title" style="width:25%"><table class="bar"><tr><td class="bar_left"></td><td class="bar_center"><?php echo $hospital_id_name[$hid]; ?> - 重复预约病人</td><td class="bar_right"></td></tr></table></div>
...
?>
	<tr<?php echo $hide_line ? " class='hide'" : ""; ?> id="list_line_<?php echo $id; ?>" style="color:<?php echo $line_color[$line["status"]]; ?>">
		...
		<td align="center" class="item"><nobr><?php echo $line["tel"]; ?></nobr></td>
		<td align="center" class="item"><?php echo $line["zhuanjia_num"]; ?></td>
		<td align="left" class="item"><?php echo $line["content"]; ?></td>
		<td align="center" class="item"><nobr><?php echo str_replace('|', '<br>', @date("Y-m-d|H:i", $line["order_date"])); ?></nobr></td>
		...
		<td align="left" class="item"><?php echo cut($line["memo"], 50, "…"); ?></td>
		<td align="center" class="item"><nobr><?php echo $line["author"]; ?></nobr></td>
		...
		<td align="center" class="item"><nobr><?php echo str_replace('|', '<br>', @date("Y-m-d|H:i", $line["addtime"])); ?></nobr></td>
