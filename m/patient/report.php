...
// 所有外线客服:
$kefu[3] = $db->query("select distinct author from $table where part_id=209 and $tf>=$lastmonth_begin and $tf<=$thismonth_end order by author", "", "author");
...
<div class="report_tips" style="margin-top:20px;"><?php echo $h_name; ?> 外线 客服预约情况</div>
