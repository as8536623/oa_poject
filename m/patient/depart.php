...
var base_src = "m/patient/depart.php";
function add(hid) {
	set_high_light('');
	parent.load_src(1, base_src+'?op=add', 650, 350);
	return false;
}

function edit(id, obj) {
	set_high_light(obj);
	parent.load_src(1, base_src+'?op=edit&id='+id, 650, 350);
	return false;
}
</script>
</head>
...
<!-- 头部 begin -->
<div class="headers">
	<div class="headers_title"><table class="bar"><tr><td class="bar_left"></td><td class="bar_center"><?php echo $hospital_id_name[$hid]; ?> - 科室列表</td><td class="bar_right"></td></tr></table></div>
