...
$limit_time = strtotime("-6 month");
$kf_arr = $db->query("select distinct author from $table where addtime>=$limit_time and author!='' and part_id in (2) order by part_id,author", "", "author");

// 清理无效的
$admin_id_name = $db->query("select realname from sys_admin where part_id in (2)", "", "realname");
...
<div>
	...
	<?php echo list_option($hospital_list, 'id', 'name', $_SESSION["hospital_id"]); ?>
