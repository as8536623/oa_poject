...
<!-- 头部 begin -->
<div class="headers">
	<div class="headers_title" style="width:45%"><table class="bar"><tr><td class="bar_left"></td><td class="bar_center"><?php echo $hospital_id_name[$hid]; ?> - 回访医生</td><td class="bar_right"></td></tr></table></div>
