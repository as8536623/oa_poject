...
function load_hospital_data($_hid) {
	...
	if (in_array("all", $data_power) || $debug_mode) {
		...
		$d["今日咨询"]["data"] = intval($data_arr["总"]["咨询"]["今日"]);
		...
		$d["今日跟踪"]["data"] = intval($data_arr["总"]["跟踪"]["今日"]);
		
		$d["今日咨询"]["link"] = "/m/ziliaoku/ku_list1.php?show=today";
        ...
        $d["今日跟踪"]["link"] = "/m/patient/patient.php?show=today&come=4";
		...
		// 昨日:
		$d["昨日咨询"]["data"] = intval($data_arr["总"]["咨询"]["昨日"]);
        ...
        $d["昨日跟踪"]["data"] = intval($data_arr["总"]["跟踪"]["昨日"]);
		
		$d["昨日咨询"]["link"] = "/m/ziliaoku/ku_list1.php?show=yesterday";
		...
		// 本月：
		$d["本月咨询"]["data"] = intval($data_arr["总"]["咨询"]["本月"]);
        ...
        $d["本月跟踪"]["data"] = intval($data_arr["总"]["跟踪"]["本月"]);
		
		$d["本月咨询"]["link"] = "/m/ziliaoku/ku_list1.php?show=thismonth";
		$d["本月预约"]["link"] = "/m/patient/patient.php?show=thismonth&time_type=addtime";
		...
		// 上月:
		$d["上月咨询"]["data"] = intval($data_arr["总"]["咨询"]["上月"]);
        ...
        $d["上月无效"]["data"] = $d["上月预约"]["data"] - $d["上月预到"]["data"];
		$d["上月跟踪"]["data"] = intval($data_arr["总"]["跟踪"]["上月"]);
		$d["上月咨询"]["link"] = "/m/ziliaoku/ku_list1.php?show=lastmonth";
		...
		// 同比:
		$d["同比咨询"]["data"] = intval($data_arr["总"]["咨询"]["同比"]);
		...
		if($author_arr){
			foreach($author_arr as $n){
				$d[$n['realname']."咨询"]["data"] = intval($data_arr["个人_".$n['realname']]["咨询"]["本月"]);
				$d[$n['realname']."预约"]["data"] = intval($data_arr["个人_".$n['realname']]["预约"]["本月"]);
				$d[$n['realname']."预到"]["data"] = intval($data_arr["个人_".$n['realname']]["预到"]["本月"]);
				$d[$n['realname']."实到"]["data"] = intval($data_arr["个人_".$n['realname']]["实到"]["本月"]);
				$d[$n['realname']."咨询"]["link"] = "/m/ziliaoku/ku_list1.php?show=thismonth&kefu_23_name=".$n['realname'];
				$d[$n['realname']."预约"]["link"] = "/m/patient/patient.php?show=thismonth&time_type=addtime&kefu_23_name=".$n['realname'];
				$d[$n['realname']."预到"]["link"] = "/m/patient/patient.php?show=thismonth&kefu_23_name=".$n['realname'];
				$d[$n['realname']."实到"]["link"] = "/m/patient/patient.php?show=thismonth&come=1&kefu_23_name=".$n['realname'];
			}
		}
