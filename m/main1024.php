...
?>
	...
	<table width="100%" class="edit">
		...
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata">今日：预约 <?php echo a4($d["今日预约"]); ?> 预到 <?php echo a4($d["今日预到"]); ?> 实到 <?php echo a4($d["今日实到"]); ?>无效<?php 
echo a4($d["今日无效"]);?></td>
		</tr>
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata" style="color:silver">月比：预约 <?php echo a4($d["月比预约"]); ?> 预到 <?php echo a4($d["月比预到"]); ?> 实到 <?php echo a4($d["月比实到"]); ?>无效<?php echo a4($d["月比过期"]); ?></td>
		</tr>
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata" style="color:silver">周比：预约 <?php echo a4($d["周比预约"]); ?> 预到 <?php echo a4($d["周比预到"]); ?> 实到 <?php echo a4($d["周比实到"]); ?>无效 <?php echo a4($d["周比过期"]); ?></td>
		</tr>
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata">昨日：预约 <?php echo a4($d["昨日预约"]); ?> 预到 <?php echo a4($d["昨日预到"]); ?> 实到 <?php echo a4($d["昨日实到"]); ?>无效 <?php echo a4($d["昨日无效"]); ?></td>
		</tr>
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata">本月：预约 <?php echo a4($d["本月预约"]); ?> 预到 <?php echo a4($d["本月预到"]); ?> 实到 <?php echo a4($d["本月实到"]); ?>无效 <?php echo a4($d["本月无效"]); ?></td>
		</tr>
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata" style="color:silver">同比：预约 <?php echo a4($d["同比预约"]); ?> 预到 <?php echo a4($d["同比预到"]); ?> 实到 <?php echo a4($d["同比实到"]); ?>无效 <?php echo a4($d["同比过期"]); ?></td>
		</tr>
		<tr onMouseOver="mi(this)" onMouseOut="mo(this)">
			<td class="idata">上月：预约 <?php echo a4($d["上月预约"]); ?> 预到 <?php echo a4($d["上月预到"]); ?> 实到 <?php echo a4($d["上月实到"]); ?>无效 <?php echo a4($d["上月无效"]); ?></td>
		</tr>
	</table>
	</div>
<?php } ?>
