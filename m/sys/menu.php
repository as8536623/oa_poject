...
$list_heads = array(
	...
	"链接" => array("align"=>"left", "sort"=>"", "order"=>"asc"),
	"功能模块" => array("align"=>"left"),
...
function show_data($t, $li) {
	switch ($t) {
		...
		case "操作":
			$op = array();
			if (check_power("edit")) $op[] = "<a href='#edit' onclick='edit(".$li["id"].", this)' class='op' title='修改内容'>修改</a>";
