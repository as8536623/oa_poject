...
?>
			<input type="checkbox" name="oprate[]" value="<?php echo $op_code; ?>" id="op_<?php echo $op_code; ?>" class="check" <?php echo $ischeck; ?>><label for="op_<?php echo $op_code; ?>"><?php echo $op_name; ?>(<?php echo $op_code; ?>)</label>&nbsp;
<?php } ?>
		</td>
	</tr>
