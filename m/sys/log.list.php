...
function is_roll() {
	return confirm("请问是否确定要恢复？恢复成功后本条记录将被删除。");
}
</script>
</head>
...
<!-- 头部 begin -->
<div class="headers">
	<div class="headers_title"><table class="bar"><tr><td class="bar_left"></td><td class="bar_center">操作日志列表</td><td class="bar_right"></td></tr></table></div>
