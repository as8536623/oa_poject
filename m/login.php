...
#password {border:2px solid #828282; cursor:help; }
...
<form action="/m/login.php?op=login" name="main" method="POST" onsubmit="return check_data()">
	...
	<div id="login_area">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td id="password_area"><input name="password" id="password" type="password" class="input" size="20" style="width:120px" value=""></td>
			</tr>
