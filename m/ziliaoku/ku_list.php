...
$aTdFormat = array(
	...
	//8=>array("title"=>"手机", "width"=>"", "align"=>"center", "sort"=>"mobile", "defaultorder"=>1),
	9=>array("title"=>"QQ", "width"=>"80", "align"=>"center", "sort"=>"qq", "defaultorder"=>1),
